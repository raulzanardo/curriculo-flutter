...
extension Localization on String {
  static final _t =
      ...
      {"pt-BR": "", "en-US": ""} +
      {
        ...
        "en-US":
            "Copal comes from “Cooperative Palletization”, it is an integrated ecosystem focused on intelligent palletization using industrial robots on a production line.",
      } +
      {
        "pt-BR":
      ...
      } +
      {
        ...
        "en-US":
            "The application was developed in Flutter for Android and iOS and is freely available, only requiring a license key so that data can be sent to the robot.",
      } +
      {
        "pt-BR":
        ...
        "en-US":
            "The user experience is simple and encourages you to follow a “Wizard” with the necessary steps to complete the parameterization. At the end of the process, the application accesses the remote screen of the robot controller so that it can be activated by the application.",
      } +
      {
        "pt-BR":
        ...
        "en-US":
            "In order to unify the user experience across the CoPal ecosystem, I also developed the graphical interface for the robot controller screen. The interface tries to be faithful to the application, even with the system's limitations.",
      } +
      {"pt-BR": "", "en-US": ""} +
      {"pt-BR": "", "en-US": ""} +
      {"pt-BR": "", "en-US": ""} +
